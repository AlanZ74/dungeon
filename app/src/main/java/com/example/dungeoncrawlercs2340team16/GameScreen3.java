...
public class GameScreen3 extends AppCompatActivity {
    ...
    private ImageView invulnPowerUpImageView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        powerUp = new PowerUpInfo(invulnPowerUpImageView, 0, 0);
    }
    private void initializeViews() {
        ...
        goalBlockImageView = findViewById(R.id.goalBlock3);
        invulnPowerUpImageView = findViewById(R.id.invulnerabilityPowerUp);
    ...
    private void setupGame() {
        ...
        chosenCharacter = getIntent().getStringExtra("CHOSEN_CHARACTER");
    ...
    private void createAndDistributeEnemies() {
        int enemyCount = 2; // For example, if you want 5 enemies
        for (int i = 0; i < enemyCount; i++) {
            EnemyType type = i % 2 == 0 ? EnemyType.TYPE3 : EnemyType.TYPE4;
    ...
    public boolean onKeyDown(int keyCode, KeyEvent event) {
        ...
        if (!notCollided) {
            invulnPowerUpImageView.setVisibility(View.GONE);
        }
        ...
        if (checkGoalCollide() && !detectedCollide) {
            ...
            Intent intent = new Intent(GameScreen3.this, EndingScreen.class);
